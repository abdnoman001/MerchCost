...
import { Linking, ScrollView, StyleSheet, Text, TouchableOpacity, View, TextInput } from 'react-native';
    ...
    return (
        <ScrollView style={styles.container}>
            ...
            <View style={styles.section}>
                <Text style={styles.sectionTitle}>Adjust Profit Margin: {profitMargin.toFixed(1)}%</Text>
        ...
        <TextInput
            ...
            onChangeText={(val) => setProfitMargin(Number(val))}
        />
      </View>
